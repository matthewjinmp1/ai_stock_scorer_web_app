...
# Go up to old_stuff directory, then into data
OLD_STUFF_DIR = os.path.dirname(os.path.dirname(SCRIPT_DIR))
DATA_DIR = os.path.join(OLD_STUFF_DIR, "data")

SCORES_FILE = os.path.join(DATA_DIR, "scores.json")
TICKER_FILE = os.path.join(DATA_DIR, "stock_tickers_clean.json")
